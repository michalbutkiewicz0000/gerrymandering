...
| Kolejka i klucze PostGIS | `tests/test_postgres_integration.py` i migracje SQL | `/ready`, zdrowy PostGIS, API i worker | migracja i usługi odebrane; dwa testy integralności kluczy wykonuje CI |
